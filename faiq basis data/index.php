...
if (mysqli_num_rows($result) > 0) {
    echo "<table>";
    echo "<tr><th>NIM</th><th>Nama</th><th>Jenis Kelamin</th><th>Tanggal Lahir</th><th>Jalan</th><th>Kota</th></tr>";
    
    while($row = mysqli_fetch_assoc($result)) {
        echo "<tr>";
        echo "<td>" . htmlspecialchars($row["nim"]) . "</td>";
        echo "<td>" . htmlspecialchars($row["nama"]) . "</td>";
        echo "<td>" . ($row["jenis_kelamin"] == 'Laki-laki' ? 'Laki-laki' : 'Perempuan') . "</td>";
